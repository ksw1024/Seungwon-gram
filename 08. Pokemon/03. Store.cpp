...
void LoadingDialog()
{
	...
	{
		Sleep(5); LoadingTag();
		Sleep(5); LoadingTag(); cout << "　　　　　　　　Ｍ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　Ｌ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮＧ" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮＧ．" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮＧ．．" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮＧ．．．" << endl << endl << endl << endl;
		Sleep(5); LoadingTag(); cout << "　　　　　　　　ＭＡＰ　ＬＯＡＤＩＮＧ．．．．　　　　　　　　" << endl << endl << endl << endl;
